...
$("#io_month_button").click(function(){
        $(".cluster_io_pro .cluster_io_block .cluster_io_plat").each(function(i){
             var s_temp=$(this).parent().find(".backcolorHover");
             s_temp.removeClass("backcolorHover");
             s_temp.parent().parent().find(".backcolor").addClass("backcolorHover");
...
<div class="panel-heading">
    <a href="#">[['Throughput'|translate]]</a>
    <a href="" class="panel-right-i"><i class="fa fa-gear"></i></a>
    <!--<div style="float:right;">
        <ul class="latency_button">
                <li class="active" id="io_day_button">日</li>
                <li id="io_week_button">周</li>
                <li id="io_month_button">月</li>
            </ul>       
    </div>-->
</div>
                ...
                {% for cluster in clusters %}
                    <div class="pro_block cluster_io_block">
                        ...
                        <div class="pro_div cluster_io_pro_div"  id={{cluster.id}} style="width:100%">
                           ...
                           <div class="pro_plat cluster_io_plat" id="placeHolder_cluster_io" style="width:100%;height:218px;position:relative;top:20px;"></div>   
